          ...
          <div className="space-y-4 bg-white rounded-md p-4 relative" >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-3">
              <div>
                ...
                <input type="text" name="destination" id="destination"  placeholder="Delhi"  className="w-full bg-gray-100 my-2  focus:outline-primary focus:outline outline-1 rounded-full p-2"/>
              </div>
              <div>
                <label htmlFor="destination" className="opacity-70">
                  Date
